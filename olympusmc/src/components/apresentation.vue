<template>
  <section class="Apresentation-container">
    <article class="Apresentation-description-container">
      <div class="Apresentation-block-1"></div>
...
.Apresentation-container {
  background-image: url("/public/images/fundo.webp");
  width: 100%;
  height: 700px;
